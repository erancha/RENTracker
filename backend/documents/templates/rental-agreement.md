...
א. והמשכיר הנו בעל הזכויות ב{{isHousingUnitText}} בת {{roomCount}} חדרים ברחוב {{propertyAddress}} (להלן: "המושכר");
...
8.4 במקרה של נזק, שאינו נזק בלאי סביר, לריהוט ו/או הציוד יחויב השוכר בתשלום שווי הריהוט ו/או הציוד, כמפורט בסעיף 11. במידה והנזק ניתן לתיקון יישא השוכר בעלותו, בהתאם להצעת מחיר מאת בעל המקצוע או הספק המתקן.
...
8.6 לא להשאיר זבל, לרבות שקיות זבל, בכל מקום שהוא מלבד בפחי האשפה המרכזיים. קרטונים וציוד אשר מיועד לאשפה יוצאו לריכוז עירוני בהתאם למועדי האיסוף של העירייה.

8.7 לא לאחסן ציוד אישי מחוץ למושכר.

8.8 השוכר מתחייב לא להיכנס לבית המשכיר מעבר לירידה ליחידת הדיור ללא הסכמה מפורשת מצד המשכיר.

8.9 לנעול את דלת המושכר ואת הכניסה הראשית למתחם והשערים. כמו כן לא לאפשר כניסת אדם שאינו מוכר לו למתחם.

**8.10 חשוב מאד! ידוע לשוכרים כי בשל שימוש במשאבה למרתף, אין לזרוק באסלה שום דבר מלבד ניר טואלט, שכן זה יכול לשרוף את המשאבה ועלות התיקון תחול על השוכרים. השוכר יישא על חשבונו בכל נזק שייגרם עקב הפרת התחייבות זו. מומלץ לא להחזיק בבית מגבונים בכלל כדי למנוע סיכון שאורח יזרוק בטעות לביוב.**

**8.11 חשוב מאוד! השוכר מתחייב לחנות אך ורק בחניונים הציבוריים שליד הבית, ולא בחניות הצמודות לווילות השכנות, ע"מ לא לייצר בעיות עם בעלי הווילות השכנות בשל עומס יחידות הדיור.**
...
9.3 המשכיר יתקן תוך זמן סביר ממועד הודעת השוכר בדבר הנזק האמור אך ורק נזקים שייגרמו מפיצוצים בצנרת, חדירות מים בגג, קצרים חשמליים. השוכר מתחייב בזאת לתקן על חשבונו כל נזק או תיקון ליקוי אחר שייגרם למושכר, וביניהם: ניקוי פילטרים מזגנים, החלפת מנורות, שנאים בגופי תאורה, ניקוי סיפונים של הכיורים, טיפול בעובש כתוצאה מחוסר אוורור וכיו"ב.
...
9.5 לא יתקבלו בקשות לפיצוי כלשהוא בגין זמן בו מערכת בבית לא עבדה וכיו"ב (ובכללן אינטרנט, כבלים, טלפון, מים, חשמל, מיזוג וכו').
...
השוכר יקבל זכות שימוש ב: {{includedEquipment}}.
לא תינתן לשוכר אחריות על הציוד הנ"ל, אולם אם קיימת אחריות יצרן ישנה אפשרות קבלת שירות עצמאית. השוכר אחראי להחזיר הציוד במצב תקין למעט בלאי טבעי.

## 12. בטחונות

12.1 השוכר יעביר למשכיר המחאה בגובה {{securityDeposit}} לפרעון מיידי שתופקד בכספתו של המשכיר לביטחון ותוחזר עם סיום תקין של ההסכם.
...
15.6 כתובות הצדדים לצורך הסכם זה הן כמפורט בתחילתו של הסכם זה, וכל הודעה שימסור צד להסכם לצד האחר תיחשב כהודעה שנתקבלה בתוך 72 שעות ממועד דיוורה כדואר רשום.
...
הערב יביא עימו **תעודת זהות** ו-2 **תלושי משכורת עדכניים**, או צילומם.
