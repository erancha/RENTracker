...
**בין:** {{tenantName}} ת.ז {{tenantId}} נייד {{tenantPhone}} מייל {{tenantEmail}} (להלן: "השוכר") **מצד אחד**
...
7.1 התשלום בסעיף 5.1 כולל דמי ניהול בעלות של: מים (מוגבל לעד {{waterLimit}} לחודש), חשמל (מוגבל לעד {{electricityLimit}} לחודש), {{includedServices}} כלולים ביחידה כבונוס. בנוסף, אין אחריות במקרי אי-קליטה סלולארית בדירה.
