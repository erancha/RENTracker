...
import { IAnalyticsDataItem } from 'redux/analytics/types';
...
class Analytics extends Component<IAnalyticsProps> {
  render() {
    const chartData = this.props.analyticsData.map((item) => ({
